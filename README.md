...
[![tests](https://img.shields.io/badge/tests-274%20passing-3fb950?style=flat-square)](#دروازهٔ-کیفیت)
...
**GitHub Lens Ultra** — an open-source observatory for Telegram, on Cloudflare Workers: 93 commands, 416 glass labels, 202 routed callback keys, 33 D1 tables, 274 tests, 5 UI languages. **[Bot](https://t.me/Gitguts_bot)** · **[Health](https://ghlens-ultra.gitguts.workers.dev/health)**
