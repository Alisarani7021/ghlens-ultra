...
export class Assistant {
  ...
  async dossier(h: H, full: string) {
    ...
    /* Always the real analysis. `ai_summary_fa` is a one-line digest for lists,
       and it used to short-circuit this screen: after the first successful
       analysis the row carried it forever, so every later press showed three
