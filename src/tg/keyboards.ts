...
export const LBL: Record<Loc, Record<string, string>> = {
  fa: {
    ...
    lang: "🌐 تغییر زبان", puzzles: "🧩 چالش هفتگی", radar: "📡 رادار شبکه",
  ...
  en: {
    ...
    lang: "🌐 Change language", puzzles: "🧩 Weekly quest", radar: "📡 Network radar",
  ...
  ar: {
    ...
    lang: "🌐 تغيير اللغة", puzzles: "🧩 تحدّي الأسبوع", radar: "📡 رادار الشبكة",
  ...
  ru: {
    ...
    lang: "🌐 Язык", puzzles: "🧩 Квест недели", radar: "📡 Радар",
  ...
  zh: {
    ...
    lang: "🌐 语言", puzzles: "🧩 每周任务", radar: "📡 网络雷达",
